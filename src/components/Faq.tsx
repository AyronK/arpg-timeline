...
export const Faq = () => (
  <section className="my-8 flex flex-col gap-4 container">
    <div>
      <h2 className="sr-only">Support</h2>
      <div className="max-w-prose mx-auto flex flex-col md:flex-row justify-between gap-2 md:gap-8">
        <Button variant={"outline"} size="lg" asChild>
          <a
            ...
            target="_blank"
          >
            <div className="h-[1.4rem] w-[1.4rem] mr-2 dark:bg-current rounded-full grid place-content-center">
              <img
                src="/assets/bmc-logo-no-background.png"
                className="h-[1rem] w-[1rem] m-auto"
        ...
        <Button variant={"outline"} size="lg" asChild>
          ...
          >
            <svg
              ...
              className="h-[1.2rem] w-[1.2rem] mr-2 fill-current"
            >
