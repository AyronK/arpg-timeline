    ...
    <ThemeProvider defaultTheme="dark" storageKey="arpgTimeline.uiTheme">
      <header>
        <div className="relative">
          ...
          <div
            className={cn(
              "absolute container right-0 left-0 top-3 md:top-8 flex flex-row gap-2 justify-end",
              themeButtonClassName,
            )}
          >
            <Button variant={"outline"} asChild className="px-2 md:px-4">
              <a
                ...
                target="_blank"
              >
                <div className="h-[1.4rem] w-[1.4rem] 2xl:mr-2 dark:bg-current rounded-full grid place-content-center">
                  <img
            ...
            <Button variant={"outline"} asChild className="px-2 2xl:px-4">
              ...
              >
                <svg
                  ...
                  className="h-[1.2rem] w-[1.2rem] 2xl:mr-2 fill-current"
                >
